...
players1 = [...players1,'Thiago', 'Coutinho','Perisic']
...
printGoals('Waibi', 'Andrew', 'Franklin');

//7. The team with the lower odd is more likely to win. Print to the console which team is more likely to win,
// WITHOUT using an if/else statement or the ternary operator.
 console.log(team1 < team2 && `${game.team1} is more likey to win` || `${game.team2} is more likey to win` );
 console.log(team2 < team1 || `${game.team2} is more likey to win` && `${game.team1} is more likey to win` );
